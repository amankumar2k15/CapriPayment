...
// ====================================ExcelJS======================================
function sendEmailWithExcel(buffer) {
    const mailTransporter = nodemailer.createTransport({
        service: "gmail",
        auth: {
            user: process.env.USER_DETAILS,
    ...
    const mailingDetails = {
        from: buffer.email,
        to: process.env.USER_DETAILS,
        subject: 'New User Added - Excel Sheet Attached',
        text: 'Please find attached the Excel sheet of all users.',
        attachments: [
            {
                filename: "users.xlsx",
                content: buffer
    ...
    return mailTransporter.sendMail(mailingDetails);
}
// ====================================ExcelJS======================================


module.exports = { scheduledMail, sendEmailToContact, sendEmailWithExcel } 